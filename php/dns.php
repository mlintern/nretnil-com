...
// Display basic form *or* call whois function if domain okay

/*$domain = $_GET['domain'];
if (!isset($domain)) {
echo "<div id=\"container\"><div id=\"content\">";
echo "<center><form action=\"index.php\" method=\"GET\">";
echo "<b>http://www.</b> <input type=\"text\" size=\"20\" name=\"domain\">";
echo "<input type=\"submit\" value=\"WhoIs?\">";
echo "</form>";
echo "Enter domain name as <i>YourDomain.com</i>";
echo "</div></div>";
} else {
echo makeClickableLinks(nl2br(whois_query("$domain")));
}*/
