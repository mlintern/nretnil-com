<?php
    ...
    $dest_url = "www.yahoo.com";   // Fill in your own URL here, or use $argv[1] to fetch from commandline.
    $maximum_hops = 2;
	...
	$get_prot = getprotobyname($protocol);
        $recv_socket = socket_create(AF_INET, SOCK_RAW, $get_prot);
	$protocol = 'udp';
	$get_prot = getprotobyname($protocol);
        $send_socket = socket_create(AF_INET, SOCK_DGRAM, $get_prot);
