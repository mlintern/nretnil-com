			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<a target="_blank" href="http://dev.nretnil.com/staging/bluevioletmuleinfluenceplayground/beigedormousemultiplyteeth/font-awesome-3.2.1" class="btn btn-info btn-sm btn-block">Font Awesome 3.2.1</a>
						<a target="_blank" href="http://dev.nretnil.com/staging/bluevioletmuleinfluenceplayground/beigedormousemultiplyteeth/font-awesome-4.0.3" class="btn btn-info btn-sm btn-block">Font Awesome 4.0.3</a>
